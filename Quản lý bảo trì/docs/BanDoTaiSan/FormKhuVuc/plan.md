...
- [x] Step 1: Viết test thất bại (lấy từ TC-S02-01 mở chế độ Tạo, TC-S02-31 Hủy đóng ngay khi chưa sửa, TC-S02-32 hỏi "Bỏ thay đổi chưa lưu?" khi đã nhập)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Viết code tối thiểu: modal slide-up từ S01, tiêu đề động, 4 trường (Tên/Mã/Loại/Nút cha), nút Hủy/Lưu/×; Nút cha đặt sẵn theo ngữ cảnh mở ("Thêm con" → nút đó; gốc → "(Gốc)"); đóng qua Hủy/×/nền tối, hỏi xác nhận nếu đã sửa dữ liệu
...
- [x] Step 1: Viết test thất bại (TC-S02-03 tạo "Phòng 307" dưới "Tầng 3"; TC-S02-04 để trống Nút cha → tạo ở gốc; TC-S02-02 Nút cha mặc định "(Gốc)"; TC-S02-05/06 lưu với Mã trống / có Loại)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Viết code tạo nút: gọi service tạo dưới đúng Nút cha hoặc gốc, ghi nhật ký kiểm toán, đóng modal (fade), cây S01 cập nhật + bật nhánh chứa nút mới, toast "Đã thêm khu vực."
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S02-09 nạp đúng dữ liệu < 1s; TC-S02-10 đổi Tên cập nhật cây; TC-S02-11 đổi Nút cha chuyển nhánh; TC-S02-12 giữ Mã cũ không coi trùng; TC-S02-13 nút đã bị xóa → "Khu vực không còn tồn tại")
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Viết code chế độ Sửa: nạp Tên/Mã/Loại/Nút cha hiện tại < 1s, lưu cập nhật (đổi cha → chuyển nhánh), ghi nhật ký kiểm toán, toast "Đã cập nhật khu vực."; xử lý nút bị xóa đồng thời
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (Tên: TC-S02-14 rỗng, TC-S02-15 chỉ khoảng trắng, TC-S02-16 biên 1, TC-S02-17 biên 150, TC-S02-18 biên 151, TC-S02-19 nút Lưu vô hiệu khi trống, TC-S02-20 trim; Mã: TC-S02-21 trùng "P305", TC-S02-22 trống cho lưu, TC-S02-23 duy nhất, TC-S02-24 biên 50, TC-S02-25 biên 51)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Viết code validation: trim Tên rồi kiểm tra 1–150 ký tự với wording "Vui lòng nhập tên khu vực." / "Tên khu vực tối đa 150 ký tự."; Mã ≤ 50 + duy nhất toàn cây (bỏ qua chính nút khi Sửa) với "Mã khu vực đã tồn tại." / "Mã khu vực tối đa 50 ký tự."; nút Lưu vô hiệu khi Tên trống; lỗi inline dưới đúng field
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S02-26 loại trừ chính nút "Tầng 3" + con "Phòng 305/306" khỏi danh sách; TC-S02-27 gán chính nó → chặn lưu; TC-S02-28 gán nhánh con → chặn lưu; TC-S02-29 chọn "Tòa B" ngoài nhánh → cho lưu; TC-S02-30 lọc tìm kiếm; TC-S02-08 cây rỗng chỉ còn "(Gốc)")
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Viết code: xây danh sách Nút cha hợp lệ loại trừ (ẩn hẳn) chính nút và toàn bộ con-cháu; validation server-side khi lưu báo "Không thể đặt khu vực vào chính nó hoặc nhánh con của nó."; ô tìm kiếm lọc theo tên khớp một phần
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S02-07 vai trò Giám sát truy cập trực tiếp → từ chối, không hiển thị form; TC-S02-34 rớt mạng khi Lưu → snackbar "Lỗi kết nối, chưa lưu được." giữ dữ liệu)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Viết code: guard chỉ Quản trị mở/lưu form (Giám sát bị từ chối ở cả lối vào và API); xử lý lỗi mạng khi lưu → snackbar, giữ nguyên dữ liệu đã nhập, không tạo/sửa nửa vời
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
