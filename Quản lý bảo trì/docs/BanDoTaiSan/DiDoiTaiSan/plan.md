...
- [ ] Step 1: Viết test thất bại (lấy từ TC-S04-01 trong test.md)
- [ ] Step 2: Chạy test, xác nhận FAIL
- [ ] Step 3: Viết code tối thiểu cho pass (mở modal đơn → chọn đích → di dời → cập nhật pin + lịch sử + nhật ký)
- [ ] Step 4: Bổ sung chặn thiếu đích (TC-S04-02), hủy không đổi (TC-S04-03), tự ghi người/thời điểm (TC-S04-17), lịch sử+nhật ký (TC-S04-18), gỡ pin cũ + tạo pin mới (TC-S04-26)
...
- [ ] Step 1: Viết test thất bại (TC-S04-04)
- [ ] Step 2: Chạy test, xác nhận FAIL
- [ ] Step 3: Viết code: tick nhiều tài sản, bộ đếm, giao dịch lô cùng đích
- [ ] Step 4: Bổ sung nút tắt khi chưa chọn (TC-S04-05), ẩn tài sản chưa có vị trí (TC-S04-06), chặn thiếu đích cho lô (TC-S04-10), tất cả về cùng đích (TC-S04-11), vai Giám sát + nhật ký (TC-S04-30)
- [ ] Step 5: Chạy test, xác nhận PASS
- [ ] Step 6: Commit
...
- [ ] Step 1: Viết test thất bại (TC-S04-07)
- [ ] Step 2: Chạy test, xác nhận FAIL
- [ ] Step 3: Viết code: chọn nút nguồn → nạp hết tài sản, bộ đếm khớp số thực có
- [ ] Step 4: Bổ sung nút nguồn rỗng (TC-S04-08), biên 1 tài sản (TC-S04-09), đích trùng toàn lô → không có gì để đổi (TC-S04-31)
- [ ] Step 5: Chạy test, xác nhận PASS
- [ ] Step 6: Commit
...
- [ ] Step 1: Viết test thất bại (TC-S04-23 — mất mạng giữa lô 200)
- [ ] Step 2: Chạy test, xác nhận FAIL
- [ ] Step 3: Viết code: transaction atomic, rollback toàn bộ khi gián đoạn, snackbar
- [ ] Step 4: Bổ sung đóng trình duyệt giữa chừng (TC-S04-24), thử lại sạch (TC-S04-25), 500 tài sản < 5s có progress (TC-S04-29)
- [ ] Step 5: Chạy test, xác nhận PASS
- [ ] Step 6: Commit
...
- [ ] Step 1: Viết test thất bại (TC-S04-19 — tài sản bị khóa không tick được)
- [ ] Step 2: Chạy test, xác nhận FAIL
- [ ] Step 3: Viết code: trạng thái khóa, icon + nhãn, vô hiệu ô tick
- [ ] Step 4: Bổ sung dialog bỏ qua → tiếp tục (TC-S04-20), từ chối → hủy lô (TC-S04-21), chặn di dời đơn bị khóa (TC-S04-22), tự mở sau 5 phút (TC-S04-27), biên 4:59 vs 5:01 (TC-S04-28)
- [ ] Step 5: Chạy test, xác nhận PASS
- [ ] Step 6: Commit
...
- [ ] Step 1: Viết test thất bại (TC-S04-15 — chặn 501 ký tự)
- [ ] Step 2: Chạy test, xác nhận FAIL
- [ ] Step 3: Viết code: maxlength 500, bộ đếm, cho phép trống vẫn lưu
- [ ] Step 4: Bổ sung lý do trống lưu được (TC-S04-13), biên đúng 500 (TC-S04-14), biên 1/499 (TC-S04-16), chỉ giữ 1 đích (TC-S04-12)
- [ ] Step 5: Chạy test, xác nhận PASS
- [ ] Step 6: Commit
...
- [ ] Step 1: Viết/đối chiếu test trạng thái Empty (TC-S04-05, TC-S04-08)
- [ ] Step 2: Chạy test, xác nhận FAIL
- [ ] Step 3: Hiện thực 4 UI state + skeleton loading + thanh tiến trình (TC-S04-29)
- [ ] Step 4: Bổ sung animation in/out (modal, bước, danh sách, toast, snackbar, dialog) + khối prefers-reduced-motion + thứ tự focus + aria-live cho lỗi/khóa
- [ ] Step 5: Chạy test, xác nhận PASS; rà a11y (tương phản WCAG AA, label, focus thấy được)
- [ ] Step 6: Commit
