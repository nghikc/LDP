...
- [x] Step 1: Viết test thất bại (TC-S01-01/02/03/04)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code tối thiểu: render cây phân cấp, toggle ▾/▸, empty-state CTA "Tạo khu vực đầu tiên"
...
- [x] Step 1: Viết test thất bại (TC-S01-05..09)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: click nút → tải ảnh + pin theo %, breadcrumb, skeleton/error/empty
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S01-10..13)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: gom cụm (BVA 500), click cụm tách/zoom, filter
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S01-27..32)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: search service không dấu, dropdown, navigate + highlight, validation field tu_khoa_tra_cuu
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S01-14..22)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: ô gán, validation tai_san_chon / toa_do_pin_x/y, audit log, toast, edge cases
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S01-23..26)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: popup pin, dialog gỡ, audit log, kiểm tra khóa
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S01-33..36)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: drag-drop, kiểm tra BRule-S01-02, gate vai trò
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S01-37..40)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: đếm ảnh hưởng, dialog, xóa nhánh + audit (BRule-S01-03)
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (TC-S01-41, TC-S01-42)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: role-gate UI, banner pin cần đặt lại, các link điều hướng
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
...
- [x] Step 1: Viết test thất bại (animation/responsive/a11y có thể đo)
- [x] Step 2: Chạy test, xác nhận FAIL
- [x] Step 3: Code: motion tokens, media queries, ARIA labels, focus-visible
- [x] Step 4: Chạy test, xác nhận PASS
- [x] Step 5: Commit
